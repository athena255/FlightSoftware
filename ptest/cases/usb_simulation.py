...
class Simulation_USB(object):
    """
    Simulates sensors and truth based on the provided testcase parameters.
    Expects USBSessions as the flight controllers.

    Testcase parameters:
    - Whether or not it is a single satellite simulation
    """
