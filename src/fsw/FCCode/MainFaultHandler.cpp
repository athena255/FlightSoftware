...
void MainFaultHandler::init() {
    ...
    std::vector<Fault*> active_list_0_safehold_super_simple_faults {
        this->find_fault("gomspace.low_batt.base", __FILE__, __LINE__),
    };

    std::vector<Fault*> active_list_1_safehold_super_simple_faults {
        this->find_fault("adcs_monitor.wheel1_fault.base", __FILE__, __LINE__),
        this->find_fault("adcs_monitor.wheel2_fault.base", __FILE__, __LINE__),
        this->find_fault("adcs_monitor.wheel3_fault.base", __FILE__, __LINE__),
        this->find_fault("adcs_monitor.wheel_pot_fault.base", __FILE__, __LINE__),
        this->find_fault("prop.overpressured.base", __FILE__, __LINE__)
    };

    std::vector<Fault*> active_list_1_standby_super_simple_faults {
        this->find_fault("prop.pressurize_fail.base", __FILE__, __LINE__),
    };
